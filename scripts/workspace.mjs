...
try {
  ...
  if (command === 'paths') {
    ...
    throw new Error('用法：npm run workspace -- paths|register|verify|bind-assets|migrate-documents [--root 作品库] [--name 名称] [--legacy-index 旧索引] [--directory 素材目录] [--shared-owners 归属映射.json] [--write]');
  }

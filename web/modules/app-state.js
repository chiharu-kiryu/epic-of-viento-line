...
export const domElements = {
  workspaceShellEl: document.getElementById('workspaceShell'),
  sidebarToggleBtnEl: document.getElementById('docSidebarToggleBtn'),
  sidebarToggleLabelEl: document.getElementById('docSidebarToggleLabel'),
  sidebarBackdropEl: document.getElementById('docSidebarBackdrop'),
  editMetricsEl: document.getElementById('docEditMetrics'),
  ...
  editFieldModeBtnEl: document.getElementById('docEditFieldModeBtn'),
  editFieldEditorEl: document.getElementById('docFieldEditor'),
...
export const APP_RUNTIME_TEXTS = localize({
  ...
  pageShell: {
    documentTitle: 'Viento Studio · OC 设计工作台',
    siteTitle: 'Viento Studio',
    siteSubtitle: '角色、故事与世界设定',
    ...
    rebuildIndexButtonText: '刷新预览',
    createTypeLabelText: '文档类型',
    createPathLabelText: '保存位置 · 可修改文件名和目录',
    createPathPlaceholder: '正文目录/文档名称.md',
    sourceModeText: '源码编辑',
    blockModeText: '分段编辑',
